...
import Laporan_petugas from "./pages/Laporan_petugas"
import Laporan_siswa from "./pages/Laporan_siswa"
    ...
    return (
      <Router>
          ...
          <Switch>
            ...
            <Route path="/laporan_petugas" component={Laporan_petugas}/>
            <Route path="/laporan_siswa" component={Laporan_siswa}/>
